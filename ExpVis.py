...
class ImageLoader(QGroupBox):
    def __init__(self):
        ...
        self.dataSets = {
            ...
            "Discrim DataSet": lambda: DiscrimDataset(transform=None, MultiLabel=True),
        }
        self.dataSet = None
        self.img = None
...
class ExplainMethodSelector(QGroupBox):
    def __init__(self):
        ...
        self.masks = {
            ...
            "AddNoise ByInv50%Hm N0.5Std": lambda hm, im: (invStd(im + binarize_add_noisy_n(hm, top=False, std=0.5)), None),
